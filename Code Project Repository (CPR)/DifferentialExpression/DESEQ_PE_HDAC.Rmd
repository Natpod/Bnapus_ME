...
```{r}
res <- results(dds, pAdjustMethod="BH") 
degQC(counts, design[["condition"]], pvalue = res[["padj"]])
```

```{r}
boxplot(vst(counts(dds)))
```
...
##Create normalized read counts
normalized_counts_Stress <- counts(dds_Stress, normalized=TRUE)

normalized_counts_mad_Stress <- apply(normalized_counts_Stress, 1, mad)
normalized_counts_Stress <- normalized_counts_Stress[order(normalized_counts_mad_Stress, decreasing=T), ]
...
Res_A_X_total_Stress <- results(dds_Stress,
name="condition_T_vs_VM",
pAdjustMethod="BH")

Res_A_X_total_Stress <- Res_A_X_total_Stress[order(Res_A_X_total_Stress$padj),]
...
write.table(normalized_counts,"/home/famgarcia/TFM/data/Testillano col/MV vs PE_HDAC/Condition_T_vs_VM_normcounts_badj_DevStage_MoR.csv",quote=FALSE, sep=",")
write.table(vst_normalized_counts,"/home/famgarcia/TFM/data/Testillano col/MV vs PE_HDAC/Condition_T_vs_VM_normcounts_badj_DevStage_vst.csv",quote=FALSE, sep=",")

write.csv(Res_A_X_total, "/home/famgarcia/TFM/data/Testillano col/MV vs PE_HDAC/Condition_T_vs_C_results_total_bce_DevStage.csv", )
write.csv(Res_A_X_total_0.05, "/home/famgarcia/TFM/data/Testillano col/MV vs PE_HDAC/Condition_T_vs_C_result_padj_0.05_DevStage.csv") 
...
```
```{r}
write.csv(pearson_cor, "/home/famgarcia/TFM/data/Testillano col/MV vs PE_HDAC/pearsonRLD_ME_HDAC_bc_DevStage.csv")
```
